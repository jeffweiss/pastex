defmodule Pastex.ContentTest do
  ...
  describe "pastes" do
    ...
    @valid_attrs %{descripton: "some descripton", name: "some name"}
    @update_attrs %{descripton: "some updated descripton", name: "some updated name"}
    @invalid_attrs %{descripton: nil, name: nil}
    ...
    test "create_paste/1 with valid data creates a paste" do
      ...
      assert paste.descripton == "some descripton"
    ...
    test "update_paste/2 with valid data updates the paste" do
      ...
      assert %Paste{} = paste
      assert paste.descripton == "some updated descripton"
    ...
    test "delete_paste/1 deletes the paste" do
      ...
      assert nil == Content.get_paste(paste.id)
    end
  ...
  describe "files" do
    ...
    test "delete_file/1 deletes the file" do
      ...
      assert nil == Content.get_file(file.id)
    end
